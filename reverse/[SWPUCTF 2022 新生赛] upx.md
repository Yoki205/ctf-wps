...
1. 先查壳，发现64位有upx壳（有壳就无法直接丢进IDA进行分析了，比较犟的可以不脱壳放进IDA试试，嘿嘿）
   ...
   ![image-20250527203039742](./images/%5BSWPUCTF%202022%20新生赛%5D%20upx_1.png)
...
2. 有壳那就脱去，那么怎么脱壳呢（脱壳其实是一个很复杂的操作，许多魔改壳，没见过的壳等等，都需要一步步动态调试脱去~~（很磨人）~~比如：
   ...
   ![image-20250527204037249](./images/%5BSWPUCTF%202022%20新生赛%5D%20upx_2.png)

   即可完成脱壳，可以再放进die里面查看，发现已经没有了

   ![image-20250527204202078](./images/%5BSWPUCTF%202022%20新生赛%5D%20upx_3.png)

3. 接下来就是放进IDA里按下F5

   ![image-20250527204312896](./images/%5BSWPUCTF%202022%20新生赛%5D%20upx_4.png)
