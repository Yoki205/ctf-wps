...
1. 先查壳，发现64位无壳
   ...
   ![image-20250527195207683](./images/%5b羊城杯 2020%5d easyre_1.png)

2. 用64位IDA打开，根据~~极其明显的~~提示，我们能定位到需要分析的函数，F5查看伪代码，如下：

   ![image-20250527195439512](./images/%5b羊城杯 2020%5d easyre_2.png)
...
4. 先分析 `encode_three`
   ...
   ![image-20250527200711943](./images/%5b羊城杯 2020%5d easyre_3.png)

   代码很简单，总结就是对每个字符做“向后 3 位”轮转，典型的**凯撒加密**

5. 接下来分析 `encode_two`

   ![image-20250527201019887](./images/%5b羊城杯 2020%5d easyre_4.png)
...
6. 最后 `encode_one`
   ...
   ![image-20250527201243552](./images/%5b羊城杯 2020%5d easyre_5.png)
