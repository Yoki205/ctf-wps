...
![image-20250527183248528](./images/%5BMoeCTF%202022%5D Base_1.png)

2. 那么直接丢到64位的IDA中进行反汇编

   ![image-20250527184719337](./images/%5BMoeCTF%202022%5D Base_2.png)

   显然，发现当前main函数有flag的提示，所有这就是我们需要分析的，对汇编代码不熟悉可以使用F5快捷键生成C语言伪代码进行分析。

3. 分析C语言伪代码

   ![image-20250527185003882](./images/%5BMoeCTF%202022%5D Base_3.png) 
...
4. 所以，我们点进去分析函数`base64_decode`
   ...
   ![image-20250527190939681](./images/%5BMoeCTF%202022%5D Base_4.png)
   ...
   ![image-20250527191230273](./images/%5BMoeCTF%202022%5D Base_5.png)
...
5. 所以，我们通过base64新表编写base64解码脚本即可得到flag！
   ...
   ![image-20250527193001816](./images/%5BMoeCTF%202022%5D Base_6.png)
