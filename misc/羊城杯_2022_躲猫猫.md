...
- 打开流量包查看一下协议分级
  ...
  ![protocal](/image/羊城杯_2022_躲猫猫/protocal.png)

- 用binwalk扫描转换成二进制文件的task.pcapng

  ![binwalk](/image/羊城杯_2022_躲猫猫/binwalk.png)
...
- zip的起始位置是`8467241 0x813329`, 结束位置是`8473973 (0x814D75)`，zip的总长度是`8473973 - 8467241 + 22 = 6754`
  ...
  ![offset](/image/羊城杯_2022_躲猫猫/offset.png)
...
- 把zip切出来，再验证是否切对了(
  ...
  ![zip](/image/羊城杯_2022_躲猫猫/zip.png)

- 确实切对了(，下一步查看key.log找解压密码，用file查看发现不认识，问gpt说是TLS/SSL Key Log，用Wireshark解密TLS

  ![tls](/image/羊城杯_2022_躲猫猫/tls.png)

- 过滤发现大量的tls会话，和http请求，发现PNG，用binwalk提取出一张乱码图

  ![miss_cat](/image/羊城杯_2022_躲猫猫/miss_cat.png)

  ![missing_cat](/image/羊城杯_2022_躲猫猫/missing_cat.png)

- 继续观察http的可疑post，追踪http流发现结尾是ff d9，是JPG格式的结尾

  ![tcp29](/image/羊城杯_2022_躲猫猫/tcp29.png)

- 导出stream29，用binwalk扫描，切出图片，内容是压缩包密码

  ![key_0](/image/羊城杯_2022_躲猫猫/key_0.png)

  ![key_1](/image/羊城杯_2022_躲猫猫/key_1.png)

  ![key](/image/羊城杯_2022_躲猫猫/key.png)
...
- 得到一个神秘图片，比较像QR，可能需要扫描之类的，经搜索发现是Maxicode，但要把中间的猫盖住
  ...
  ![cat](/image/羊城杯_2022_躲猫猫/cat.png)

- ps一下，用解密网站扫描得到flag

  ![ps](/image/羊城杯_2022_躲猫猫/ps.png)

- 解密网站：[Maxicode](https://products.aspose.app/barcode/zh-hans/recognize/maxicode#)

  ![decode](/image/羊城杯_2022_躲猫猫/decode.png)
